      ...
      <div className="relative">
        ...
        <nav className="flex justify-between items-center py-4 px-6 relative z-10">
          ...
          <Link to="/dashboard" className="text-white font-mono">
            ...
            <Link to="/login" className="text-white font-sans transition-all duration-300 hover:text-orange-300 hover:scale-110">
              LOGIN
            </Link>
            <Link to="/signup" className="text-white font-sans transition-all duration-300 hover:text-orange-300 hover:scale-110">
              SIGNUP
            </Link>
          </div>
        </nav>
